...
Backbone.Paginator = (function ( Backbone, _, $ ) {
	...
	Paginator.clientPager = Backbone.Collection.extend({
		...
		sync: function ( method, model, options ) {
			//console.log('In clientPager SYNC (paginator.js)');
    		var self = this; 
		...
		pager: function () {
			//console.log('In Client PAGER (paginator.js)');
			var self = this,
				disp = this.perPage,
	...
	Paginator.requestPager = Backbone.Collection.extend({
		...
		sync: function ( method, model, options ) {
			//console.log('In SYNC (paginator.js)');
			var self = this;
			...
			queryOptions.url += decodeURIComponent($.param(queryAttributes));
			
			//console.log('url: '+_.result(queryOptions, 'url') + ' (paginator.js)');
			return $.ajax( queryOptions );
		...
		pager: function ( options ) {
			//console.log('In requestPager PAGER (paginator.js)');
